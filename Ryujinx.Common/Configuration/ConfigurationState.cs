...
namespace Ryujinx.Configuration
{
    public class ConfigurationState
    {
        ...
        public class SystemSection
        {
            ...
            {
                Language                = new ReactiveObject<Language>(); //{ Name = "Language", Category = "System" };
                Region                  = new ReactiveObject<Region>(); //{ Name = "Region", Category = "System" };
                TimeZone                = new ReactiveObject<string>(); //{ Name = "Timezone", Category = "System" };
                SystemTimeOffset        = new ReactiveObject<long>(); //{ Name = "Time Offset", Category = "System" };
                ...
                EnableFsIntegrityChecks = new ReactiveObject<bool>(); //{ Name = "Fs Integrity", Category = "System" };
                FsGlobalAccessLogMode   = new ReactiveObject<int>(); //{ Name = "Global Log Mode", Category = "System" };
